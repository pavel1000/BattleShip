...
# Form implementation generated from reading ui file '.\ship_placement.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.field = QtWidgets.QWidget(MainWindow)
        ...
        self.field.setMaximumSize(QtCore.QSize(960, 540))
        self.field.setObjectName("field")
        self.fieldLayout = QtWidgets.QHBoxLayout(self.field)
        self.fieldLayout.setObjectName("fieldLayout")
        self.groupBox = QtWidgets.QGroupBox(self.field)
        ...
        self.fieldLayout.addWidget(self.groupBox)
        self.frame_2 = QtWidgets.QFrame(self.field)
        ...
        self.fieldLayout.addWidget(self.frame_2)
        MainWindow.setCentralWidget(self.field)
